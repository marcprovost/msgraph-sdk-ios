...
typedef void (^MSGraphUserOwnedObjectsCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphUserOwnedObjectsCollectionReferencesRequest *nextRequest, NSError *error);
