...
typedef void (^MSGraphDirectoryObjectsCollectionCompletionHandler)(MSCollection *response, MSGraphDirectoryObjectsCollectionRequest *nextRequest, NSError *error);
